...
fn literal_to_message(variant: StringLiterals) -> &'static str{
    match variant{
        ...
        StringLiterals::RePlusMismatchedTypes => "Runtime error: Mismatched types used on + operand\n",
        StringLiterals::RePlusUnsupportedType => "Runtime error: Only Number and string can be used with + operand\n",
        StringLiterals::ReMinusUnsupportedType => "Runtime error: Only Number can be used with - operand\n",
        StringLiterals::ReMulUnsupportedType => "Runtime error: Only Number can be used with * operand\n",
        StringLiterals::ReDivUnsupportedType => "Runtime error: Only Number can be used with / operand\n",
...
pub fn gen_global_string_literals<'a>(
    ...
    for i in 0..StringLiterals::SIZE as usize{
        ...
        let ptr = b.build_global_string_ptr(mes, "compiler_printf_literal")?.as_pointer_value();
        arr[i] = Some(ptr);
    }
...
pub fn global_string_literal<'a>(which: StringLiterals, state: &State<'a>) -> values::PointerValue<'a> {
